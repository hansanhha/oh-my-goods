...
public class CartController {
    ...
    @GetMapping
    public ResponseEntity<Slice<CartResponse>> getCarts(@AuthenticationPrincipal AuthenticatedAccount account,
        ...
        return ResponseEntity.ok(cartService.getAll(account.memberId(), Pageable.ofSize(size).withPage(page)));
    }
