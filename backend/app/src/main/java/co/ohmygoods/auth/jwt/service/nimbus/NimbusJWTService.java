...
import co.ohmygoods.auth.jwt.model.vo.*;
...
import static co.ohmygoods.auth.jwt.model.vo.TokenType.REFRESH_TOKEN;
...
public class NimbusJWTService implements JWTService {
    ...
    private JWTInfo buildJWTInfo(JWTClaimsSet jwtClaimsSet, String token) {
        return JWTInfo
                ...
                .oAuth2Vendor(OAuth2AuthorizationService.OAuth2Vendor.valueOf(jwtClaimsSet.getClaim(VENDOR.name()).toString().toUpperCase()))
