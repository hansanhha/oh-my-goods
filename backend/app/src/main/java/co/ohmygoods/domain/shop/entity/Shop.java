package co.ohmygoods.domain.shop.entity;

import co.ohmygoods.domain.account.entity.OAuth2Account;
import co.ohmygoods.domain.global.BaseEntity;
import co.ohmygoods.domain.shop.exception.InvalidShopOwnerException;
import co.ohmygoods.domain.shop.exception.UnchangeableShopStatusException;
